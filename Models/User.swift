...
//  App
//
//  Created by Julius Abarra on 13/10/2017.
//
...
final class User: Model {
    ...
    init(code: String, lastName: String, firstName: String, middleName: String, gender: Int, birthdate: String, address: String, mobile: String, email: String, type: Int, username: String, encryptedUsername: String, password: String, encryptedPassword: String, imageUrl: String, owner: Int, dateCreated: Date, dateUpdated: Date) {
        self.id = nil
